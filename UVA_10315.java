...
public class Porker_3 {
	...
	public static void main(String[] args) {
		...
		while(input.hasNext()) {
			...
			System.out.println("white Number: " + whiteAnswer);
			System.out.println("black Number: " + blackAnswer);
		}
	}
